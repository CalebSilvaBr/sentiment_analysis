...
toy_features, toy_labels = toy_data = utils.load_toy_data('toy_data.txt')
...
pegasus_class = p1.classify(test_bow_features, theta, theta_0)
acc = p1.accuracy(pegasus_class, test_labels)
print(acc)
#-------------------------------------------------------------------------------
